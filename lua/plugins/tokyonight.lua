return
{
  ...
  opts = {
    ...
    on_highlights = function(hl, c)
      ...
      hl.DiagnosticVirtualLinesError = { fg = c.error, bg = c.bg_dark, italic = true }
      hl.DiagnosticVirtualLinesWarn  = { fg = c.warning, bg = c.bg_dark, italic = true }
      hl.DiagnosticVirtualLinesInfo  = { fg = c.info, bg = c.bg_dark, italic = true }
      hl.DiagnosticVirtualLinesHint  = { fg = c.hint, bg = c.bg_dark, italic = true }
    end,
  },
  init = function()
